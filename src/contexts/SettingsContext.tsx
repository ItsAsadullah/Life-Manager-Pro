...
const translations: Record<Language, Record<string, string>> = {
  ...
  bn: {
    ...
    reminderDeleted: 'রিমাইন্ডার মুছে ফেলা হয়েছে',    searchPlaceholder: 'নাম বা ফোন দিয়ে খুঁজুন...',
    amount: 'টাকার পরিমাণ',
    ...
    paymentBank: 'ব্যাংকিং',
    errorGeneratingPDF: 'PDF তৈরি করতে সমস্যা হয়েছে',
    income: 'আয়',
    expense: 'ব্যয়',
    sinceLastMonth: 'গত মাসের তুলনায়',
    moreFilter: 'বেশি',
    lessFilter: 'কম',
    balance: 'ব্যালেন্স',
    all: 'সব',
    ...
    noTransactionsThisMonth: 'এই মাসে কোনো লেনদেন নেই',
    willGet: 'পাবো',
    willGive: 'দিবো',
    people: 'জন ব্যক্তি',
    noPersonFound: 'কোনো ব্যক্তি পাওয়া যায়নি',
    settled: 'পরিশোধিত',
    got: 'পেয়েছি',
    gave: 'দিয়েছি',
    transactionDetails: 'লেনদেনের বিস্তারিত',
    date: 'তারিখ',
    debtsReport: 'ধারের রিপোর্ট',
    reportGenerationDate: 'রিপোর্ট তৈরির তারিখ',
    currentBalance: 'বর্তমান ব্যালেন্স',
    cash: 'নগদ',
    personName: 'ব্যক্তির নাম',
    addPerson: 'ব্যক্তি যুক্ত করুন',
  }
};
      ...
      if (user) {
        try {
          ...
          if (docSnap.exists() && Array.isArray(docSnap.data().reminders)) {
            const remoteReminders = docSnap.data().reminders;
            if (remoteReminders.length > 0) {
              setNotificationRemindersState(remoteReminders);
            }
          }
        } catch (error) {
